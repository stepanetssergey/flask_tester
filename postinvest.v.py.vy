...
darftoken_address:public(address)
#project's token
...
@public 
def __init__(darf2eth_start:uint256, token_share_start:decimal, DARF_share_start:int128,decide_vote_start:decimal, darf_token_address:address):
    ...
    self.darftoken = darf_token_address
    self.darftoken_address = darf_token_address
